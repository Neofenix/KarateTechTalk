...
insert publishers values('1389', 'Al;data Infosystems', 'Berkeley', 'CA', 'USA')
insert publishers values('9952', 'Scootney Books', 'New York', 'NY', 'USA')
insert publishers values('1622', 'Five Lakes Publishing', 'Chica;', 'IL', 'USA')
...
'This is sample text data for Al;data Infosystems, publisher 1389 in the pubs database. Al;data Infosystems is located in Berkeley, California.
...
'This is sample text data for Five Lakes Publishing, publisher 1622 in the pubs database. Five Lakes Publishing is located in Chica;, Illinois.
...
insert titles values ('PS7777', 'Emotional Security: A New Al;rithm', 'psychology',
...
insert titles values('MC3021', 'The ;urmet Microwave', 'mod_cook', '0877', $2.99,
$15000.00, 24, 22246,
...
insert employee values ('DWR65030M', 'Die;', 'W', 'Roel', 6, 192, '1389', '12/16/91')
